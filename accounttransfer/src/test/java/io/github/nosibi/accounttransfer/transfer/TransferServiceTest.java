...
class TransferServiceTest {
    ...
    String toAccountNumber = "000-000-00000"; //예외 발생하는 조건
    ...
    void openAccountForTransfer(){
        ...
        accountService.openAccount(toAccountNumber, toAccountPassword);
    }
    ...
    @Test
    void transferTest(){
        transferService.transfer(fromAccountNumber,fromAccountPassword,toAccountNumber, 10000L);
        assertThat(accountService.checkAccountBalance(fromAccountNumber,fromAccountPassword)).isEqualTo(0L);
        assertThat(accountService.checkAccountBalance(toAccountNumber,toAccountPassword)).isEqualTo(10000L);
    }
    ...
    void failLogTest(){
        ...
        assertThat(accountService.checkAccountBalance(toAccountNumber,toAccountPassword)).isEqualTo(0L);
        assertThat(transferLogService
                .transferLogList(fromAccountNumber, toAccountNumber,null,null,null,null).get(0).getStatus())
